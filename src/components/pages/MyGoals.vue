<template>
  <div class="container text-secondary">
    <div class="row">
      <div class="col">
        <h1 v-if="myGoalsStore.getLengthMyGoals" class="text-center">My goals for the future!</h1>
    ...
    <div class="row align-items-center">
      <div class="col-8">
        <h2 v-if="myGoalsStore.getLengthMyGoals">
          Total my goals: <span class="text-primary">{{ myGoalsStore.getLengthMyGoals }}</span>
        </h2>
      </div>
    ...
    <div v-if="myGoalsStore.getLengthMyGoals" class="card mt-4">
